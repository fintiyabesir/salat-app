...
- BatoulApps Adhan Kotlin is MIT licensed.
- The MUIS consolidated prayer timetable on data.gov.sg is available under the Singapore Open Data Licence v1.0; product use requires conspicuous source/licence attribution.
