...
The optional offline manual-city catalog is derived from the GeoNames geographical database.
...
This notice must remain available from the application's About / Licenses surface whenever a GeoNames-derived catalog is distributed with the app.
